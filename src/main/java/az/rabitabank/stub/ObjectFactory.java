 ...
 * generated in the az.rabitabank.stub package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: az.rabitabank.stub
     * 
     */
